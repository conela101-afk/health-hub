...
- **Service directory** — 52 specialty categories spanning general medicine (cardiology, rheumatology, gastroenterology, dermatology, and more), cancer care (adult oncology and the designated cancer centres, alongside gynaecological & breast cancer), stroke, older persons & geriatric medicine, men's health & prostate, CAMHS, adult disability, addiction, allied health, general paediatrics, and weight management, neurodiversity (adult and child ADHD/autism pathways — public and private, ROI and NI — alongside CDNT/early-intervention and Education Authority SEN routes for children), and women's health in depth (maternity & obstetrics, gynaecology, endometriosis, menopause, fertility, and more), across public and private providers. National-level programmes and organisations are covered nationwide; region-specific clinic/service listings are being built out area by area (currently deepest for Cork — more regions are an ongoing, explicit priority, not an afterthought).
- **Know your rights** — a self-advocacy guide (including realistic expectations for adult ADHD/autism diagnosis and the private/shared-care caveat on both sides of the border), letter templates for FOI/SAR requests and formal complaints, the complaints escalation ladder for both Ireland and Northern Ireland, Freedom of Information contacts covering all 6 HSE Hospital Groups (with detailed, individually-verified contacts for ~16 major hospitals) plus all 5 Northern Ireland HSC Trusts, entitlement and disability-employment schemes (Medical Card, NTPF waiting-list rights, Fair Deal, Disability Allowance/PIP, Work and Access/Access to Work, and more), and a directory of national advocacy/support organisations.
...
- **Keep language general, not gendered, by default.** Most of the site (general medicine, the advocacy/rights guide, letter templates, crisis and out-of-hours info) applies to everyone and should read that way. Only use women-specific framing where the entry is genuinely about a women's-health-specific topic or organisation (maternity, gynae, endometriosis, menopause, fertility, a women's-health charity/campaign, etc.) — don't let it default in elsewhere. This site grew out of an earlier women's-health-only PWA, and that origin keeps resurfacing as leftover framing in shared, non-content copy — the homepage hero blurb, the meta/manifest descriptions, and section intros like the Support-orgs/General-support callouts. None of those describe a single entry; they describe the whole site or a whole tab, so a women's-health-first framing there misrepresents everything else (general medicine, neurodiversity/ADHD/autism, disability, advocacy) as secondary. When adding or editing any sitewide or section-level description, check it against the site's actual current scope, not the scope it had when that sentence was last written.
